...
# 论文方法的实验以及实验结果结果  
本文先使用网格调参法调出基分类器的最佳参数，具体调参的过程如下图所示：![image](https://github.com/ynwu838/Excellent-Graduation-project-in-STU/blob/main/%E5%9B%BE%E7%89%87/e363190dc313682a21c558ccad20545.png)  
